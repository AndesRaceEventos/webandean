...
import 'package:webandean/pages/entregas/entrega%20general/dropdown_row/dropdown_row.dart';
import 'package:webandean/pages/entregas/entrega%20general/footer_table/footer_table.dart';
import 'package:webandean/pages/entregas/entrega%20general/generate_data/generate_data.dart';
import 'package:webandean/pages/entregas/entrega%20general/table_actions/actions_button_table.dart';
import 'package:webandean/pages/entregas/entrega%20general/table_header/header_progress_equipo.dart';
import 'package:webandean/pages/entregas/entrega%20general/table_header/header_progress_producto.dart';
...
class PageEntregaGeneral extends StatelessWidget {
  const PageEntregaGeneral({super.key});

  @override
  Widget build(BuildContext context) {
    final dataParticipantes = Provider.of<TEntregasAppProvider>(context);
...
class _PageResponsiveProductosState extends State<_PageResponsiveProductos> {
  ...
  void initState() {
    ...
    Provider.of<TEntregasAppProvider>(context, listen : false).clearSearch([]);
    });
  }
                        ...
                        child: istransition
                            ? MyGridView(
                                ...
                                childrenBuilder: (value, constraints) {
                                 ...
                                 final TEntregasModel e = value as TEntregasModel;
                                  return  Column(
                              ...
                              builder: (context) {
                                return  ScrollWeb(
                                    child:  ResponsiveTableCustom(
                                      expandIdRealtion: () {
                                        filterAsginalIDRelaions(context); /// Esto es personalizado 
                                      },
                                      ...
                                      dropContainer: (data) => dropDowButonbar(data), // La función que genera el dropdown
  ...
  void isSeachVisible(TEntregasAppProvider dataProvider,List<TEntregasModel> listProductos ){
  ...
  void isRefreshDataSearh(TEntregasAppProvider dataProvider,List<TEntregasModel> listProductos) {
