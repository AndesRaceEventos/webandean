  ...
  List<Map<String, dynamic>> applyFilter(String? searchText) {
    ...
    if (searchText == "" || searchText == null) {
      ...
      final filteredData = sourceOriginal.where((data) {
        TListaEntregaEquiposModel e = data['data'];
        return TListaEquipoAppProvider().filterByFields(value: searchText, data: e);
...
List<Map<String, dynamic>> generateData(dynamic dataParticipantes) {
  List<TListaEntregaEquiposModel> dataTable = dataParticipantes;
  ...
  for (var e in dataTable) {
    temps.add({
      ...
      "active": e.active,
      "listaProducto": e.listaEquipos?.length ?? 0,
      //BARRA PROGRESO
