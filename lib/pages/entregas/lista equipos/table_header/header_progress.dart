          ...
          child: ListTile(
            ...
            title: Row(
              children: [
                ...
                Expanded(child: H3Text(text: 'Inversión (100%)'.toUpperCase(), fontSize: 11, 
        ...
        return Container(
         ...
         decoration: BoxDecoration(
          ...
          child: ListTile(
            ...
            minVerticalPadding: 0,
            // leading:
            //     Icon(Icons.bar_chart_outlined, size: 15, color: Colors.black54),
            // title: H3Text(text: 'progress'.toUpperCase(), fontSize: 11),
             title: Row(
              children: [
                Icon(Icons.bar_chart_outlined, size: 15, color: AppColors.menuTextDark),
                SizedBox(width: 5), // Espacio entre icono y texto
                Expanded(child: H3Text(text: 'progress'.toUpperCase(), fontSize: 11, 
                color: AppColors.menuTextDark, textAlign: TextAlign.center,  maxLines: 2)),
              ],
            ),
          ),
