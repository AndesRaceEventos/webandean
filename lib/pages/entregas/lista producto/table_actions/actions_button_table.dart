...
import 'package:webandean/pages/entregas/lista%20producto/editing_forma_p.dart';
...
//todos ********************** ESPECIFICOS *****************  */
  ...
  Widget fomrView({
    ...
    TListaEntregaProductosModel? dataDrop = dataDrops;
    return Positioned(
      right: 0,
  ...
  void isDeleteForm(
    ...
    if (!isdelete) {
      ...
      print(id);
      await context
          .read<TListaProductosAppProvider>()
