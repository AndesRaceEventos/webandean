...
// import 'package:webandean/pages/equipo/p_gridview_product.dart';
import 'package:webandean/pages/equipo/footer_table/footer_table.dart';
import 'package:webandean/pages/equipo/dropdown_row/dropdown_row.dart';
import 'package:webandean/pages/equipo/generate_data/generate_data.dart';
import 'package:webandean/pages/equipo/table_header/header_progress.dart';
import 'package:webandean/pages/equipo/table_actions/actions_button_table.dart';
...
class PageEquipos extends StatelessWidget {
  const PageEquipos({super.key});

  @override
  Widget build(BuildContext context) {
    final dataParticipantes = Provider.of<TEquipoAppProvider>(context);
...
class _PageResponsiveProductos extends StatefulWidget {
  ...
  @override
  State<_PageResponsiveProductos> createState() =>  _PageResponsiveProductosState();
}
...
class _PageResponsiveProductosState extends State<_PageResponsiveProductos> {
  ...
  void initState() {
    ...
    Provider.of<TEquipoAppProvider>(context, listen : false).clearSearch([]);
    });
  }
  ...
  @override
  Widget build(BuildContext context) {
    final dataProvider = Provider.of<TEquipoAppProvider>(context);
                        ...
                        child: istransition
                            ? MyGridView(
                                ...
                                childrenBuilder: (value, constraints) {
                                 // Casteamos el dynamic a TEquiposAppModel
                                 final TEquiposAppModel e = value as TEquiposAppModel;
                                  return  Column(
                              ...
                              builder: (context) {
                                return  ScrollWeb(
                                    child:  ResponsiveTableCustom(
                                      ...
                                      dtaHeaderListProgress: () => headerColorsValue(), //TODOS progreso, ESPECIFICO.
                                      dtaHeaderListProgress2: ()=> headerProgress(),
  ...
  void isSeachVisible(TEquipoAppProvider dataProvider,List<TEquiposAppModel> listProductos ){
  ...
  void isRefreshDataSearh(TEquipoAppProvider dataProvider,List<TEquiposAppModel> listProductos) {
