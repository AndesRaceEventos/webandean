...
DatatableHeader headerColorsValue() {
  return DatatableHeader(
    text: "colors",
    value: "colors",
    show: true,
        ...
        return Container(
         ...
         constraints: BoxConstraints(maxWidth: maxWidth), // Limita el ancho del header
            ...
            child: ListTile(
              ...
              minLeadingWidth: 0, 
              minVerticalPadding: 0,
              leading: Icon(Icons.color_lens_rounded, size: 15, color: AppColors.menuTextDark),
              title: H3Text(text: 'colors'.toUpperCase(), fontSize: 11,
               color: AppColors.menuTextDark, textAlign: TextAlign.center,)
            ),
          );
        }
              ...
              child: Wrap(
                children: [
                  ...List.generate(
                    colors.length,
                    (index) {
                     final  color = AppColors.getColorFromHex(colors[index]);
                      return Container(
                      height: 10,
                      width: 10,
