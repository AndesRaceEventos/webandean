...
import 'package:webandean/pages/itinerarios/dropdown_row/dropdown_row.dart';
import 'package:webandean/pages/itinerarios/footer_table/footer_table.dart';
import 'package:webandean/pages/itinerarios/generate_data/generate_data.dart';
import 'package:webandean/pages/itinerarios/table_actions/actions_button_table.dart';
import 'package:webandean/pages/itinerarios/table_header/header_progress.dart';
...
class PageItinerarios extends StatelessWidget {
  const PageItinerarios({super.key});

  @override
  Widget build(BuildContext context) {
    final dataParticipantes = Provider.of<TItinerariosAppProvider>(context);
...
class _PageResponsiveProductosState extends State<_PageResponsiveProductos> {
  ...
  @override
  Widget build(BuildContext context) {
    final dataProvider = Provider.of<TItinerariosAppProvider>(context);
  ...
  void isSeachVisible(TItinerariosAppProvider dataProvider,List<TItinerioApuModel> listProductos ){
  ...
  void isRefreshDataSearh(TItinerariosAppProvider dataProvider,List<TItinerioApuModel> listProductos) {
