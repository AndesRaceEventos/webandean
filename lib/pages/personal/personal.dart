...
import 'package:webandean/pages/personal/dropdown_row/dropdown_row.dart';
import 'package:webandean/pages/personal/footer_table/footer_table.dart';
import 'package:webandean/pages/personal/generate_data/generate_data.dart';
import 'package:webandean/pages/personal/table_actions/actions_button_table.dart';
...
class PagePersonal extends StatelessWidget {
  const PagePersonal({super.key});

  @override
  Widget build(BuildContext context) {
    final dataParticipantes = Provider.of<TPersonalAppProvider>(context);
...
class _PageResponsiveProductosState extends State<_PageResponsiveProductos> {
  ...
  void initState() {
    ...
    Provider.of<TPersonalAppProvider>(context, listen : false).clearSearch([]);
    });
  }
  ...
  @override
  Widget build(BuildContext context) {
    final dataProvider = Provider.of<TPersonalAppProvider>(context);
                        ...
                        child: istransition
                            ? MyGridView(
                                ...
                                childrenBuilder: (value, constraints) {
                                 ...
                                 final TPersonalApuModel e = value as TPersonalApuModel;
                                  return  Column(
  ...
  void isSeachVisible(TPersonalAppProvider dataProvider,List<TPersonalApuModel> listProductos ){
  ...
  void isRefreshDataSearh(TPersonalAppProvider dataProvider,List<TPersonalApuModel> listProductos) {
