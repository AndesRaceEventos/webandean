...
class TListaProductosApp {
  static const String collectionName = 'almacen_lista_productos';

   // Método reutilizable para procesar la respuesta
  static List<TListaEntregaProductosModel> processResponse(List<RecordModel> response) {
    return response.map((e) {
      ...
      return TListaEntregaProductosModel.fromJson(e.data);
    }).toList();
  }
