...
class TEquipoApp {
  static const String collectionName = 'almacen_equipos';

   // Método reutilizable para procesar la respuesta
  static List<TEquiposAppModel> processResponse(List<RecordModel> response) {
    return response.map((e) {
      ...
      return TEquiposAppModel.fromJson(e.data);
    }).toList();
  }
