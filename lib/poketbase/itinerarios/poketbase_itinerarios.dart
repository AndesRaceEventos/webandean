...
class TItinerariosApp {
  static const String collectionName = 'programa_apu';

   // Método reutilizable para procesar la respuesta
  static List<TItinerioApuModel> processResponse(List<RecordModel> response) {
    return response.map((e) {
      ...
      return TItinerioApuModel.fromJson(e.data);
    }).toList();
  }
