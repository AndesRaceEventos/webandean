...
class TPersonalApp {
  static const String collectionName = 'operaciones_personal';

   // Método reutilizable para procesar la respuesta
  static List<TPersonalApuModel> processResponse(List<RecordModel> response) {
    return response.map((e) {
      ...
      return TPersonalApuModel.fromJson(e.data);
    }).toList();
  }
