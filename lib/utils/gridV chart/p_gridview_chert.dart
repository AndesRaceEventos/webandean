                ...
                child: FittedBox(
                  child: Column(
                    ...
                    children: [
                      ...
                      }, onLongPress: menuProvider.option != 1 ?  null : () => menuProvider.randomizelabelRotation([0,-20]),),),//pasar lal ista de valores que va tomar label position
                      ...
                      }, onLongPress:menuProvider.option != 2 ?  null : () => menuProvider.randomizelabelRotation([-20,-80]),),),
                      ...
                      }, onLongPress:menuProvider.option != 3 ?  null : () => menuProvider.randomizelabelRotation([1,4]),),),
                      ...
                      }, onLongPress: menuProvider.option != 4 ?  null :() => menuProvider.randomizelabelRotation([2,3]),),),
                      cardCutom(context: context, number:5 ,child: AppIconButon(child: AppSvg().lineascharSvg, onPressed: () {
                        menuProvider.setOption(5);
                        menuProvider.labelRotationIndex = -20;
                      }, onLongPress: menuProvider.option != 5 ?  null :() => menuProvider.randomizelabelRotation([-20,-80]),),),
                      cardCutom(context: context, number:6 ,child: AppIconButon(child: AppSvg().areaChartSvg,onPressed: () {
                        menuProvider.setOption(6);
                      }, onLongPress: menuProvider.option != 6 ?  null :() => menuProvider.randomizelabelRotation([-20,-80]),),),
                    ],
                  ),
                ),
              ),
